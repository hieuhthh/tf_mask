...
url = "https://drive.google.com/file/d/1C1KNTcgvxlMOF-lzU7B7OphncEPSdFrr/view?usp=share_link"
output =  f"{des}/encoder_v1_best_model_EfficientNetV2S_160_512_364103.h5"
gdown.download(url=url, output=output, quiet=False, fuzzy=True)